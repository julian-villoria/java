		...
		<div class="container px-lg-5">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item"><a class="nav-link active hvr-grow" style="padding-right: 18px"
			...
			<div class="col-md">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							<td><%=i.getJugador().getUsuario()  %></td>
							<td><%= i.getTorneo().getJuego().getDenominacion() %></td>
							<td><%= i.getTorneo().getTipoTorneo().getDenominacion() %></td>
							<td><%= i.getTorneo().getFechaInicio() %></td>
							<td><%= i.getTorneo().getFechaFin() %></td>
							<td><%= i.getFechaInscripcion() %></td>
							<td><%= i.getTorneo().getJuego().getDificultad().getNombre() %>
							</td>
						</tr>
						<% } %>
						<% } %>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="juegoNuevo">Juego:</label> <select name="juegoNuevo"
								id="juegoNuevo">
								<% if(!dataJuego.isEmpty()){ %>
								<% for(Juego j: dataJuego){ %>
								<option value="<%= j.getDenominacion() %>">
									<%= j.getDenominacion() %>
								</option>
								<% } %>
								<% } %>
						...
						<div class="form-group">
							<label for="tipoTorneoNuevo">Tipo de Torneo:</label> <select
								name="tipoTorneoNuevo" id="tipoTorneoNuevo">
								<% if(!dataTipo.isEmpty()){ %>
						...
						<div class="form-group">
							<label for="fechaInicioNuevo">Fecha Inicio del Torneo</label> <input
								type="date" class="form-control" id="fechaInicioNuevo"
								name="fechaInicioNuevo">
						</div>
						<div class="form-group">
							<label for="fechaInscNuevo">Fecha Inscripcion</label> <input
								type="date" class="form-control" id="fechaInscNuevo"
								name="fechaInscNuevo">
						</div>
						<div class="form-group">
							<label for="jugadorNuevo">Usuario Jugador</label> <input
								type="text" class="form-control" id="jugadorNuevo"
								name="jugadorNuevo">
						</div>
					</div>
		...
		<div class="modal-dialog" role="document">
			<form method="post" action="ServletInscripcionCrud">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="juegoActualizar">Juego:</label> <select
								name="juegoActualizar" id="juegoActualizar">
								<% if(!dataJuego.isEmpty()){ %>
								<% for(Juego j: dataJuego){ %>
								<option value="<%= j.getDenominacion() %>">
									<%= j.getDenominacion() %>
						...
						<div class="form-group">
							<label for="tipoTorneoActualizar">Tipo de Torneo:</label> <select
								name="tipoTorneoActualizar" id="tipoTorneoActualizar">
								<% if(!dataTipo.isEmpty()){ %>
								<% for(TipoTorneo tt: dataTipo){ %>
								<option value="<%= tt.getDenominacion() %>"><%= tt.getDenominacion() %></option>
								<% } %>
						...
						<div class="form-group">
							<label for="fechaInicioActualizar">Fecha Inicio del
								Torneo</label> <input type="date" class="form-control"
								id="fechaInicioActualizar" name="fechaInicioActualizar">
						</div>
						<div class="form-group">
							<label for="fechaInscActualizar">Fecha Inscripcion</label> <input
								type="date" class="form-control" id="fechaInscActualizar"
								name="fechaInscActualizar">
						</div>
						<div class="form-group">
							<label for="jugadorActualizar">Usuario Jugador</label> <input
								type="text" class="form-control" id="jugadorActualizar"
								name="jugadorActualizar">
						</div>
						<div class="modal-footer">
		...
		<div class="modal-dialog" role="document">
			<form method="post" action="ServletInscripcionCrud">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="juegoEliminar">Juego:</label> <select
								name="juegoEliminar" id="juegoEliminar">
								<% if(!dataJuego.isEmpty()){ %>
								<% for(Juego j: dataJuego){ %>
								<option value="<%= j.getDenominacion() %>">
									<%= j.getDenominacion() %>
						...
						<div class="form-group">
							<label for="tipoTorneoEliminar">Tipo de Torneo:</label> <select
								name="tipoTorneoEliminar" id="tipoTorneoEliminar">
								<% if(!dataTipo.isEmpty()){ %>
								<% for(TipoTorneo tt: dataTipo){ %>
								<option value="<%= tt.getDenominacion() %>"><%= tt.getDenominacion() %></option>
								<% } %>
						...
						<div class="form-group">
							<label for="fechaInicioEliminar">Fecha Inicio</label> <input
								type="date" class="form-control" id="fechaInicioEliminar"
								name="fechaInicioEliminar">
						</div>
						<div class="form-group">
							<label for="jugadorEliminar">Usuario Jugador</label> <input
								type="text" class="form-control" id="jugadorEliminar"
